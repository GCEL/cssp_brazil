...
mnthly_mean_data_nw_all <- as.data.frame(mnthly_mean_data_nw)
mnthly_mean_data_nw_all$region_name<-mnthly_all_pixels_compare_data_zero[mnthly_all_pixels_compare_data_zero$region_name=='amazon_nw',]$region_name
mnthly_mean_data_nw <- as.data.frame(melt(mnthly_mean_data_nw[,c(1:3,5,7)], id.vars ='mnth'))
...
mnthly_mean_data_sw_all <- as.data.frame(mnthly_mean_data_sw)
mnthly_mean_data_sw_all$region_name<-mnthly_all_pixels_compare_data_zero[mnthly_all_pixels_compare_data_zero$region_name=='amazon_sw',]$region_name
mnthly_mean_data_sw <- as.data.frame(melt(mnthly_mean_data_sw[,c(1:3,5,7)], id.vars ='mnth'))
...
mnthly_mean_data_ec_all <- as.data.frame(mnthly_mean_data_ec)
mnthly_mean_data_ec_all$region_name<-mnthly_all_pixels_compare_data_zero[mnthly_all_pixels_compare_data_zero$region_name=='amazon_ec',]$region_name
mnthly_mean_data_ec <- as.data.frame(melt(mnthly_mean_data_ec[,c(1:3,5,7)], id.vars ='mnth'))
...
mnthly_mean_data_bs_all <- as.data.frame(mnthly_mean_data_bs)
mnthly_mean_data_bs_all$region_name<-mnthly_all_pixels_compare_data_zero[mnthly_all_pixels_compare_data_zero$region_name=='amazon_bs',]$region_name
mnthly_mean_data_bs <- as.data.frame(melt(mnthly_mean_data_bs[,c(1:3,5,7)], id.vars ='mnth'))
...
mnthly_mean_data_gs_all <- as.data.frame(mnthly_mean_data_gs)
mnthly_mean_data_gs_all$region_name<-mnthly_all_pixels_compare_data_zero[mnthly_all_pixels_compare_data_zero$region_name=='amazon_gs',]$region_name
mnthly_mean_data_gs <- as.data.frame(melt(mnthly_mean_data_gs[,c(1:3,5,7)], id.vars ='mnth'))
...
mnthly_mean_data_amazonia_all <- as.data.frame(mnthly_mean_data_amazonia)
mnthly_mean_data_amazonia_all$region_name<-mnthly_all_pixels_compare_data_zero[mnthly_all_pixels_compare_data_zero$region_name=='amazonia',]$region_name
mnthly_mean_data_amazonia <- as.data.frame(melt(mnthly_mean_data_amazonia[,c(1:3,5,7)], id.vars ='mnth'))

mnthly_mean_data_all_2 <- bind_rows(mnthly_mean_data_nw_all,mnthly_mean_data_sw_all,mnthly_mean_data_ec_all,mnthly_mean_data_bs_all,mnthly_mean_data_gs_all,mnthly_mean_data_amazonia_all)
...
mnthly_mean_data_nw%>%
  ...
  geom_line(aes(colour = variable),size=4)+ 
  geom_label_repel(aes(label = label),nudge_x = 2,na.rm = TRUE,size=5) +
  theme_bw() + 
...
mnthly_mean_data_bs%>%
  ...
  geom_line(aes(colour = variable),size=4)+ 
  geom_label_repel(aes(label = label),nudge_x = 1,na.rm = TRUE,size=5) +
  theme_bw() + 
  theme(text = element_text(size = 16),panel.border = element_blank(), panel.grid.major = element_blank(),
        panel.grid.minor = element_blank(), axis.line = element_line(colour = "black"),legend.position='none')
mnthly_mean_data_gs%>%
...
mnthly_mean_data_all%>%
  mutate(label = if_else(mnth == 'Dec', as.character(region_name), NA_character_)) %>%
  ggplot(aes(mnth,gpp,group=region_name))+
  labs(title="Monthly Mean of Normalised GPP over Amazonia",x="Month", y = "Normalized Values") +
  geom_line(aes(colour = region_name),size=3)+
  geom_label_repel(aes(label = label),nudge_x = 1,na.rm = TRUE,size=4) +
  theme_bw() +
  theme(text = element_text(size = 16),panel.border = element_blank(), panel.grid.major = element_blank(),
        panel.grid.minor = element_blank(), axis.line = element_line(colour = "black"))
mnthly_mean_data_all_2%>%
  mutate(label = if_else(mnth == 'Dec', as.character(region_name), NA_character_)) %>%
  ggplot(aes(mnth,gpp,group=region_name))+
  labs(title="Monthly Mean of Normalised GPP over Amazonia",x="Month", y = "Normalized Values") +
  geom_line(aes(colour = region_name),size=3)+
  geom_label_repel(aes(label = label),nudge_x =2,na.rm = TRUE,size=4) +
  theme_bw() +
  theme(text = element_text(size = 16),panel.border = element_blank(), panel.grid.major = element_blank(),
        panel.grid.minor = element_blank(), axis.line = element_line(colour = "black"))
```
...
```{r echo = FALSE, message=FALSE, fig.asp = 0.8, fig.width = 10}
all_pixels_compare_data_zero_nw<-scale(all_pixels_compare_data_zero[all_pixels_compare_data_zero$region_name=='amazon_nw',c(1:6)])
all_pixels_compare_data_zero_nw <- as.data.frame(all_pixels_compare_data_zero_nw)
all_pixels_compare_data_zero_nw$mnth<-all_pixels_compare_data_zero[all_pixels_compare_data_zero$region_name=='amazon_nw',]$month_f
all_pixels_compare_data_zero_nw_scale <- as.data.frame(all_pixels_compare_data_zero_nw)
all_pixels_compare_data_zero_nw_scale$region_name<-all_pixels_compare_data_zero[all_pixels_compare_data_zero$region_name=='amazon_nw',]$region_name

all_pixels_compare_data_zero_sw <- scale(all_pixels_compare_data_zero[all_pixels_compare_data_zero$region_name=='amazon_sw',c(1:6)])
all_pixels_compare_data_zero_sw <- as.data.frame(all_pixels_compare_data_zero_sw)
all_pixels_compare_data_zero_sw$mnth<-all_pixels_compare_data_zero[all_pixels_compare_data_zero$region_name=='amazon_sw',]$month_f
all_pixels_compare_data_zero_sw_scale <- as.data.frame(all_pixels_compare_data_zero_sw)
all_pixels_compare_data_zero_sw_scale$region_name<-all_pixels_compare_data_zero[all_pixels_compare_data_zero$region_name=='amazon_sw',]$region_name

all_pixels_compare_data_zero_ec <- scale(all_pixels_compare_data_zero[all_pixels_compare_data_zero$region_name=='amazon_ec',c(1:6)])
all_pixels_compare_data_zero_ec <- as.data.frame(all_pixels_compare_data_zero_ec)
all_pixels_compare_data_zero_ec$mnth<-all_pixels_compare_data_zero[all_pixels_compare_data_zero$region_name=='amazon_ec',]$month_f
all_pixels_compare_data_zero_ec_scale <- as.data.frame(all_pixels_compare_data_zero_ec)
all_pixels_compare_data_zero_ec_scale$region_name<-all_pixels_compare_data_zero[all_pixels_compare_data_zero$region_name=='amazon_ec',]$region_name

all_pixels_compare_data_zero_bs <- scale(all_pixels_compare_data_zero[all_pixels_compare_data_zero$region_name=='amazon_bs',c(1:6)])
all_pixels_compare_data_zero_bs <- as.data.frame(all_pixels_compare_data_zero_bs)
all_pixels_compare_data_zero_bs$mnth<-all_pixels_compare_data_zero[all_pixels_compare_data_zero$region_name=='amazon_bs',]$month_f
all_pixels_compare_data_zero_bs_scale <- as.data.frame(all_pixels_compare_data_zero_bs)
all_pixels_compare_data_zero_bs_scale$region_name<-all_pixels_compare_data_zero[all_pixels_compare_data_zero$region_name=='amazon_bs',]$region_name

all_pixels_compare_data_zero_gs <- scale(all_pixels_compare_data_zero[all_pixels_compare_data_zero$region_name=='amazon_gs',c(1:6)])
all_pixels_compare_data_zero_gs <- as.data.frame(all_pixels_compare_data_zero_gs)
all_pixels_compare_data_zero_gs$mnth<-all_pixels_compare_data_zero[all_pixels_compare_data_zero$region_name=='amazon_gs',]$month_f
all_pixels_compare_data_zero_gs_scale <- as.data.frame(all_pixels_compare_data_zero_gs)
all_pixels_compare_data_zero_gs_scale$region_name<-all_pixels_compare_data_zero[all_pixels_compare_data_zero$region_name=='amazon_gs',]$region_name

all_pixels_compare_data_zero_amazonia <- scale(all_pixels_compare_data_zero[all_pixels_compare_data_zero$region_name=='amazonia',c(1:6)])
all_pixels_compare_data_zero_amazonia <- as.data.frame(all_pixels_compare_data_zero_amazonia)
all_pixels_compare_data_zero_amazonia$mnth<-all_pixels_compare_data_zero[all_pixels_compare_data_zero$region_name=='amazonia',]$month_f
all_pixels_compare_data_zero_amazonia_scale <- as.data.frame(all_pixels_compare_data_zero_amazonia)
all_pixels_compare_data_zero_amazonia_scale$region_name<-all_pixels_compare_data_zero[all_pixels_compare_data_zero$region_name=='amazonia',]$region_name

all_pixels_compare_data_zero_scale <- bind_rows(all_pixels_compare_data_zero_nw_scale,all_pixels_compare_data_zero_sw_scale,all_pixels_compare_data_zero_ec_scale,all_pixels_compare_data_zero_bs_scale,all_pixels_compare_data_zero_gs_scale,all_pixels_compare_data_zero_amazonia_scale)

all_pixels_compare_data_zero_scale[!all_pixels_compare_data_zero_scale$region_name=='amazonia',] %>%
  ggplot(aes(x=cica, 
             y=gpp, 
             colour = region_name))+
...
```{r echo = FALSE, message=FALSE, fig.asp = 0.8, fig.width = 7}
mnthly_all_pixels_compare_data_zero[!mnthly_all_pixels_compare_data_zero$region_name=='amazonia',] %>%
  ggplot(aes(x=cica, 
             y=gpp, 
             colour = region_name))+
  geom_point(alpha = 1/20)+
...
2.5: lm plots of various monthly mean variable combinations for every region on scaled date
```{r echo = FALSE, message=FALSE, fig.asp = 0.8, fig.width = 7}
mnthly_mean_data_all_2 %>%
  ggplot(aes(x=cica, 
             y=gpp, 
             colour = region_name))+
  geom_point(alpha = 1/20)+
  labs(title="Plot of GPP against CiCa",x="CiCa", y = "GPP",size=5)+
  stat_poly_line(se = FALSE,size=2)+
  stat_poly_eq(aes(label = paste(after_stat(rr.label), sep = "*\", \"*")),size=5)+
  theme_bw() + 
  theme(text = element_text(size = 16),panel.border = element_blank(), panel.grid.major = element_blank(),
        panel.grid.minor = element_blank(), axis.line = element_line(colour = "black"))
...
mnthly_mean_data_all_2 %>%
  ggplot(aes(x=lai, 
             ...
             colour = region_name))+
  geom_point(alpha = 1/20)+
  labs(title="Plot of GPP against LAI",x="LAI", y = "GPP",size=5)+
  stat_poly_line(se = FALSE,size=2)+
  stat_poly_eq(aes(label = paste(after_stat(rr.label), sep = "*\", \"*")),size=5)+
  theme_bw() + 
  theme(text = element_text(size = 16),panel.border = element_blank(), panel.grid.major = element_blank(),
...
mnthly_mean_data_all_2 %>%
  ggplot(aes(x=gsdsr, 
             ...
             colour = region_name))+
  geom_point(alpha = 1/20)+
  labs(title="Plot of GPP against gs demand:supply",x="GSDSR", y = "GPP",size=5)+
  stat_poly_line(se = FALSE,size=2)+
  stat_poly_eq(aes(label = paste(after_stat(rr.label), sep = "*\", \"*")),size=5)+
  theme_bw() + 
  theme(text = element_text(size = 16),panel.border = element_blank(), panel.grid.major = element_blank(),
...
mnthly_mean_data_all_2 %>%
  ggplot(aes(x=apar, 
             ...
             colour = region_name))+
  geom_point(alpha = 1/20)+
  labs(title="Plot of GPP against APAR",x="APAR", y = "GPP",size=5)+
  stat_poly_line(se = FALSE,size=2)+
  stat_poly_eq(aes(label = paste(after_stat(rr.label), sep = "*\", \"*")),size=5)+
  theme_bw() + 
  theme(text = element_text(size = 16),panel.border = element_blank(), panel.grid.major = element_blank(),
...
mnthly_mean_data_all_2 %>%
  ggplot(aes(x=et, 
             ...
             colour = region_name))+
  geom_point(alpha = 1/20)+
  labs(title="Plot of GPP against against Evapotranspiration",x="ET", y = "GPP",size=5)+
  stat_poly_line(se = FALSE,size=2)+
  stat_poly_eq(aes(label = paste(after_stat(rr.label), sep = "*\", \"*")),size=5)+
  theme_bw() + 
  theme(text = element_text(size = 16),panel.border = element_blank(), panel.grid.major = element_blank(),
...
mnthly_mean_data_all_2 %>%
  ggplot(aes(x=apar, 
             ...
             colour = region_name))+
  geom_point(alpha = 1/20)+
  labs(title="Plot of CiCa against APAR",x="APAR", y = "CiCa",size=5)+
  stat_poly_line(se = FALSE,size=2)+
  stat_poly_eq(aes(label = paste(after_stat(rr.label), sep = "*\", \"*")),size=5)+
  theme_bw() + 
  theme(text = element_text(size = 16),panel.border = element_blank(), panel.grid.major = element_blank(),
...
mnthly_mean_data_all_2 %>%
  ggplot(aes(x=et, 
             ...
             colour = region_name))+
  geom_point(alpha = 1/20)+
  labs(title="Plot of GSDSR against ET",x="ET", y = "GSDSR",size=5)+
  stat_poly_line(se = FALSE,size=2)+
  stat_poly_eq(aes(label = paste(after_stat(rr.label), sep = "*\", \"*")),size=5)+
  theme_bw() + 
  theme(text = element_text(size = 16),panel.border = element_blank(), panel.grid.major = element_blank(),
...
mnthly_mean_data_all_2 %>%
  ggplot(aes(x=cica, 
             ...
             colour = region_name))+
  geom_point(alpha = 1/20)+
  labs(title="Plot of GSDSR against CiCa",x="CiCa", y = "GSDSR",size=5)+
  stat_poly_line(se = FALSE,size=2)+
  stat_poly_eq(aes(label = paste(after_stat(rr.label), sep = "*\", \"*")),size=5)+
  theme_bw() + 
  theme(text = element_text(size = 16),panel.border = element_blank(), panel.grid.major = element_blank(),
