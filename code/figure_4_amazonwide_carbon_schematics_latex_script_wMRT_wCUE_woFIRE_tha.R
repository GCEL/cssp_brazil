...
# Define the output file name for the created script
outfilename = paste("tha_wCUE_wMRT_woFIRE_",PROJECT$name,"_latex_C_budget.tex",sep="")
...
print(paste(chartr("_"," ",PROJECT$name)," DONE",sep=""))
